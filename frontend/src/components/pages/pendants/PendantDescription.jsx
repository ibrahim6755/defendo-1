    ...
    return (
        <div className="product-description-wrapper p-4">
            <div className="row">
                ...
                <div className="mob-col  col-md-4 d-md-none">
                ...
                <div className="col-md-5 right-col align-items-start">
                    ...
                    {/* <div className="ring-size">
                        <p>Ring Size:</p>
                        <select name="" id="" className='w-100 p-1' value={selectedSize} onChange={(e) => setSelectedSize(e.target.value)}>
                            <option className=''>16" inches</option>
                            <option className=''>17" inches</option>
                            <option className=''>18" inches</option>
                            <option className=''>19" inches</option>
                            <option className=''>20" inches</option>
                        </select>
                    ...
                    <div className="ring-color mt-3">
                        ...
                        <div className="color-btn">
                            <a href="#golden"><button className='bg-warning p-3 me-3 w-10' onClick={() => setSelectedColor('Golden')}></button></a>
                            <a href="#silver"><button className='bg-secondary p-3 me-3 w-10' onClick={() => setSelectedColor('Silver')}></button></a>
                        </div>
                    </div> */}
